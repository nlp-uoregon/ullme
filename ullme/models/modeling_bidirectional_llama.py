# The following code is modified from transformers.models.llama.modeling_llama.py
...
class BidirectionalLlama(LlamaPreTrainedModel):
    """
...
class BidirectionalLlamaForCausalLM(LlamaPreTrainedModel):
    _tied_weights_keys = ["lm_head.weight"]

    def __init__(self, config):
        super().__init__(config)
        self.model = BidirectionalLlama(config)
        self.vocab_size = config.vocab_size
